...
JointTrajPtFullMessage JointTrajectoryInterface::create_message(int robot_id, int seq, int valid_fields, double time, std::vector<double> joint_pos, std::vector<double> joint_vel, std::vector<double> joint_acc)
{
