...
(cl:in-package inexbot_reva_service-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Person-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name inexbot_reva_service-srv:<Person-request> is deprecated: use inexbot_reva_service-srv:Person-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inexbot_reva_service-srv:name-val is deprecated.  Use inexbot_reva_service-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inexbot_reva_service-srv:age-val is deprecated.  Use inexbot_reva_service-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <Person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inexbot_reva_service-srv:sex-val is deprecated.  Use inexbot_reva_service-srv:sex instead.")
  (sex m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Person-request>)))
  ...
  "inexbot_reva_service/PersonRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Person-request)))
  "Returns string type for a service object of type 'Person-request"
  "inexbot_reva_service/PersonRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Person-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name inexbot_reva_service-srv:<Person-response> is deprecated: use inexbot_reva_service-srv:Person-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Person-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inexbot_reva_service-srv:result-val is deprecated.  Use inexbot_reva_service-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Person-response>)))
  ...
  "inexbot_reva_service/PersonResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Person-response)))
  "Returns string type for a service object of type 'Person-response"
  "inexbot_reva_service/PersonResponse")
